...
bank$Education <- NULL
head(as.data.frame(education_dummy))
...
new_customer[, c("Age", "Experience", "Income", "CCAvg", "Mortgage")] <- 
  predict(norm_model, new_customer[, c("Age", "Experience", "Income", "CCAvg", "Mortgage")])
