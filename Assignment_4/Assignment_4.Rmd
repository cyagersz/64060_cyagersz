...
Cluster 1: These firms are geographically diverse. They have Locations in Canada, Germany, UK, and the US. All of them are in NYSE.

Cluster 2: These firms are mainly in the US which is 8 companies but have 2 in the UK and 1 in Switzerland. All of them exchange in the NYSE.

Cluster 3: These firms are concentrated in France, Ireland, and the US. Where they exchange is more varied which is in AMEX, NASDAQ, and NYSE.

Conclusion: Clusters based on financial variables also show patterns in firm location, and stock exchange. This suggests that financial performance, geography, and market listing are related, giving further insight into the structure of the pharmaceutical industry.
